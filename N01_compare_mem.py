...
oldlink="https://btae.web.cern.ch/btae/cgi-bin/igprof-navigator/igprof_"+args.old+"_"+args.step+"_MEM.99"
newlink="https://btae.web.cern.ch/btae/cgi-bin/igprof-navigator/igprof_"+args.new+"_"+args.step+"_MEM.99"
...
for old_str2,new_str2 in zip(old_list_str2,new_list_str2):
    ...
    if not link_list:
        continue;
    old_str2_link="https://btae.web.cern.ch"+link_list[0]
    ...
    if not link_list:
        continue;
    new_str2_link="https://btae.web.cern.ch"+link_list[0]
